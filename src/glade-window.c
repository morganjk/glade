...
glade_window_populate_intro (GladeWindow *window)
{
  ...
  ADD_NODE (NULL, "recent-button", BOTTOM, 2, _("a recently used"));
  ADD_NODE (NULL, "new-button",    BOTTOM, 2, _("or create a new one"));

  ADD_NODE ("new-project", NULL,       NONE, .75, NULL);

  ADD_NODE (NULL, "undo-button",       BOTTOM, 1, _("Undo"));
  ADD_NODE (NULL, "redo-button",       BOTTOM, 1, _("Redo"));
  ADD_NODE (NULL, "project-switcher",  BOTTOM, 2, _("Project switcher"));
  ...
  ADD_NODE (NULL, "intro-button",  BOTTOM, 3, _("Quite easy! is not it?"));
...
glade_window_constructed (GObject *object)
{
  ...
  /* Init Glade version */
  version = g_strdup_printf ("Version %d.%d.%d", GLADE_MAJOR_VERSION, GLADE_MINOR_VERSION, GLADE_MICRO_VERSION);
